...
<nav class="mt-5 px-2">
 <div class="flex flex-col space-y-4">
    <a href="{{route('tweet.index')}}" class="{{ request()->is('tweet') ? 'bg-gray-800 text-blue-300' : '' }} group flex items-center px-4 py-2 text-base leading-6 font-semibold rounded-full hover:bg-gray-800 hover:text-blue-300">
    ...
    <a href="{{route('tweet.trending')}}" class="group flex items-center px-4 py-2 text-base leading-6 font-semibold rounded-full hover:bg-gray-800 hover:text-blue-300">
    ...
    <a href="{{route('notify.index')}}" class="relative group flex items-center px-4 py-2 text-base leading-6 font-medium rounded-full hover:bg-gray-800 hover:text-blue-300">
        <svg class="mr-4 h-6 w-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <a href="{{ route('chat.index') }}" class="relative group flex items-center px-4 py-2 text-base leading-6 font-medium rounded-full hover:bg-gray-800 hover:text-blue-300 transition-all duration-300">
    ...
    <a href="{{route('bookmarks.index')}}" class="{{ request()->is('bookmarks') ? 'bg-gray-800 text-blue-300' : '' }} group flex items-center px-4 py-2 text-base leading-6 font-semibold rounded-full hover:bg-gray-800 hover:text-blue-300">
        <svg class="mr-4 h-6 w-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <a href="{{route('profile.show',['id'=>$user->id])}}" class="{{ request()->is('profile') ? 'bg-gray-800 text-blue-300' : '' }} group flex items-center px-4 py-2 text-base leading-6 font-semibold rounded-full hover:bg-gray-800 hover:text-blue-300 ">
        <svg class="mr-4 h-6 w-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" stroke="currentColor" viewBox="0 0 24 24">
