            ...
            <div class="w-3/5 border border-gray-600 h-auto  border-t-0">
                ...
                <div class="flex">
                    <div class="flex-1 m-2">
                        <h2 class="px-4 py-2 text-xl font-semibold text-white">    @lang('messages.home') 
                        </h2>
                    </div>
                ...
                <div class="flex">
                    ...
                    <div class="flex-1 px-2 pt-2 mt-2">
                        <textarea name="post" class=" bg-transparent text-gray-400 font-medium text-lg w-full" rows="2" cols="50" placeholder=" ..@lang('messages.good')"></textarea>
                    </div>                    
                </div>
                    ...
                    <div class="w-64 px-2">
                        ...
                        <div class="flex items-center">
                            <div class="flex-1 text-center px-1 py-1 m-2">
                                ...
                                <input name="images" type="file" id="file-upload" class="hidden">
