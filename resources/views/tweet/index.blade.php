...
<body>
    ...
    <div class="text-white" style="background-color: #15202b;">
        <div class="flex">
            ...
            <div class="w-3/5 border border-gray-600 h-auto  border-t-0">
                ...
                <div class="flex">
                    ...
                    <div class="flex-1 px-2 pt-2 mt-2">
                        <textarea name="post" class=" bg-transparent text-gray-400 font-medium text-lg w-full" rows="2" cols="50" placeholder="What's happening?"></textarea>
                    </div>                    
                </div>
